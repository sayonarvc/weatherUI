export const temperatureSection = document.querySelector('.temperature-section');
export const addedLocations = document.querySelector('.added-locations');
export const form = document.querySelector('.header-container');
